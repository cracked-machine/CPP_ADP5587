...
enum class DummyBaseIsrEnum { exti5, isr_type2, capacity };
...
template void adp5587::Driver<DummyBaseIsrEnum>::get_key_events(
    std::array<adp5587::Driver<DummyBaseIsrEnum>::KeyPadMappings, 10> &key_events_list);
